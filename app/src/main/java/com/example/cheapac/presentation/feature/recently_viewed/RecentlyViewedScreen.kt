...
@Composable
fun RecentlyViewedRoute(viewModel: RecentlyViewedViewModel = hiltViewModel()) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()
    RecentlyViewedScreen(uiState = uiState)
}

@Composable
fun RecentlyViewedScreen(uiState: RecentlyViewedUiState) {
